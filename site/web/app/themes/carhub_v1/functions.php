...
echo '<div class="cars-slider_item-option car-option-' . $attribute_slug . '"><h5>Doors:<span class="attribute">' . $text . '</span></h5></div>';
}
...
$array = wc_get_product_terms( $product_id , 'pa_' . $attribute_slug, array( 'fields' => 'names' ) );
$text = array_shift( $array );
echo '<div class="cars-slider_item-option car-option-' . $attribute_slug . '"><h5>passengers:<span class="attribute">' . $text . '</span></h5></div>';
}
...
$array = wc_get_product_terms( $product_id , 'pa_' . $attribute_slug, array( 'fields' => 'names' ) );
$text = array_shift( $array );
echo '<div class="cars-slider_item-option car-option-' . $attribute_slug . '"><h5>luggage:<span class="attribute">' . $text . '</span></h5></div>';
}
...
$array = wc_get_product_terms( $product_id , 'pa_' . $attribute_slug, array( 'fields' => 'names' ) );
$text = array_shift( $array );
echo '<div class="cars-slider_item-option car-option-' . $attribute_slug . '"><h5>transmission:<span class="attribute">' . $text . '</span></h5></div>';
}
...
$array = wc_get_product_terms( $product_id , 'pa_' . $attribute_slug, array( 'fields' => 'names' ) );
$text = array_shift( $array );
echo '<div class="cars-slider_item-option car-option-' . $attribute_slug . '"><h5>air condtitoning:<span class="attribute">' . $text . '</span></h5></div>';
}
...
$array = wc_get_product_terms( $product_id , 'pa_' . $attribute_slug, array( 'fields' => 'names' ) );
$text = array_shift( $array );
echo '<div class="cars-slider_item-option car-option-' . $attribute_slug . '"><h5>Drive wheel:<span class="attribute">' . $text . '</span></h5></div>';
}
